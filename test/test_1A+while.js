...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
const searchInputValue = "oeuf beurre farine lait chocolat";
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//
//--------api----------
function api() {
...
function searchOneStr(type, recipes, str) {
  ...
  const unionResult = union(...allArrays);
  return unionResult;
}

//---split-str and return array---
function searchValueArray(value) {
  return value.toLowerCase().split(" ");
} // "str1 str2 str3" => ["str1","str2","str3"]
//
//---------------search expression--------------------
function search(type) {
  const splittedStr = searchValueArray(searchInputValue);
