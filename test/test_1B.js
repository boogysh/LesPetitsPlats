...
function union(...arrays) {
  ...
  for (let i = 0; i < array1.length; i++) {
    if (
      array2.includes(array1[i]) == false &&
      array3.includes(array1[i]) == false
    ) {
  ...
  for (let i = 0; i < array2.length; i++) {
    if (
      array1.includes(array2[i]) == false &&
      array3.includes(array2[i]) == false
    ) {
  ...
  for (let i = 0; i < array3.length; i++) {
    if (
      array1.includes(array3[i]) == false &&
      array2.includes(array3[i]) == false
    ) {
  ...
  const union = [...intersaction, ...unique];

  return union;
}

const result = searchOneStr("main", recipes, searchInputValue);
